...
namespace QuestGiver.Server.Migrations
{
    ...
    [Migration("20240815223031_AddOneTimeToQuestsAndOneTimeQuestsCompletedToQuestLog")]
    partial class AddOneTimeToQuestsAndOneTimeQuestsCompletedToQuestLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuestGiver.Shared.Models.Quest", b =>
                {
                    ...
                    b.Property<bool>("OneTime")
                        .HasColumnType("bit")
                        .HasAnnotation("Relational:JsonPropertyName", "oneTime");
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "quests");
                });
            ...
            modelBuilder.Entity("QuestGiver.Shared.Models.QuestLog", b =>
                {
                    ...
                    b.Property<int>("OneTimeQuestsCompleted")
                        .HasColumnType("int")
                        .HasAnnotation("Relational:JsonPropertyName", "oneTimeQuestsCompleted");
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "questLog");
                });

            modelBuilder.Entity("QuestGiver.Shared.Models.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PersonName")
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "personName");
